...
object $_scalate_$deleteResult_jade {
  def $_scalate_$render($_scalate_$_context: _root_.org.fusesource.scalate.RenderContext): Unit = {
    ...
    ;{
      ...
      ;{
        val delResult: String = $_scalate_$_context.attribute("delResult")
        $_scalate_$_context << ( "<html></html>\n<title>Search Result Page</title>\n<body>\n  <h1>Result after Delete:</h1>\n  <p>" );
        $_scalate_$_context <<< (         delResult
 );
...
class $_scalate_$deleteResult_jade extends _root_.org.fusesource.scalate.Template {
  def render(context: _root_.org.fusesource.scalate.RenderContext): Unit = $_scalate_$deleteResult_jade.$_scalate_$render(context)
}
