...
object $_scalate_$searchPage_jade {
...
class $_scalate_$searchPage_jade extends _root_.org.fusesource.scalate.Template {
  def render(context: _root_.org.fusesource.scalate.RenderContext): Unit = $_scalate_$searchPage_jade.$_scalate_$render(context)
}
